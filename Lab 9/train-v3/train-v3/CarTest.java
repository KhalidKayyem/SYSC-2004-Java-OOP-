...
public class CarTest extends junit.framework.TestCase
{
    ...
    public void testBookNextSeat()
    {
        ...
        // repeat for economy class.
        
        Car BCar;
        BCar = new Car(12345, false);
        
        Seat[] seats2 = BCar.seats(); // seat objects of size of 40
        // Verify that no seats are booked. //
    ...
    public void testCancelSeat()
    {
        ...
        //assertFalse(seats[50].cancelBooking()); this errors
        //assertFalse(seats2[50].cancelBooking()); this as well
    }      
}
