...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        // Create items
        Item car = new Item("a grey car", 1.5);
        Item book = new Item("an old dusty book", 1.5);
        Item laptop = new Item("a powerful gaming laptop", 2.3);
        Item key = new Item("a small rusty key", 0.1);
        Item coffee = new Item("a cup of coffee", 0.5);
    ...
    private void look(Command command) {
        ...
        System.out.println(currentRoom.getLongDescription());      
        if (itemTaken != null) {
            System.out.println("You are carrying: " + itemTaken.getDescription());
        } else {
