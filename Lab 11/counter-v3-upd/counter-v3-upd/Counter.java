...
public class Counter implements ActionListener
{
   ...
   // The button to set the counter to a random number.
   private JButton randomButton; 
   
   // The value the random counter will take the user to.
   ...
   public Counter() {
      ...
      clearItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, SHORTCUT_MASK)); // found a pattern LOL
   ...
   /** 
    * actionPerformed This action listener is called when the user clicks on 
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (o instanceof JButton) {
            ...
            if (button == downButton) { // decrement
                ...
                randomCounter = new Random();
                count = randomCounter.nextInt(MAXIMUM+1);
            }
            ...
            if (item == resetItem) { // reset
                count = RESET_TO;
            } else if (item == clearItem) { // clear the menu items
                history.setText("");
            }
