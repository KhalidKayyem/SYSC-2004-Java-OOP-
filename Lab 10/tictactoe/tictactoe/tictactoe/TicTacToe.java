...
public class TicTacToe
{
   ...
   /**
    * clearBoard Sets everything up for a new game.  Marks all squares in the Tic Tac Toe board as empty,
   ...
   /**
    * playGame Plays one game of Tic Tac Toe.
    */
